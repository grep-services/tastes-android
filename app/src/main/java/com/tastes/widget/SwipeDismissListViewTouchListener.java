 ...
 * ensure that this {@link com.tastes.widget.SwipeDismissListViewTouchListener} is paused during list view
 * scrolling.</p>
 *
 * <p>Example usage:</p>
 *
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link com.tastes.widget.SwipeDismissListViewTouchListener} to inform its client
     ...
     * {@link com.tastes.widget.SwipeDismissListViewTouchListener} is paused during list view scrolling.</p>
     *
     * @see {@link com.tastes.widget.SwipeDismissListViewTouchListener}
     */
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (mDownPosition > 0 && Math.abs(deltaX) > mViewWidth / 2) { // both(from 2nd item)
