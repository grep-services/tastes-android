...
public class Image implements Serializable {
    ...
    // default(for query)
    public Image(int id, String origin, String thumbnail, String time, String address, long distance, List<String> tags, List<String> positions, List<String> orientations) {
        this(id, origin, thumbnail, null, time, address, 0, 0, distance, tags, positions, orientations);
    }
    ...
    // total constructor
    public Image(int id, String origin, String thumbnail, Bitmap bitmap, String time, String address, double latitude, double longitude, long distance, List<String> tags, List<String> positions, List<String> orientations) {
        this.id = id;
        this.origin = origin;
