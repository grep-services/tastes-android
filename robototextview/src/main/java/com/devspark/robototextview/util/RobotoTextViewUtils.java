    ...
    public static void initTypeface(TextView textView, Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (a.hasValue(R.styleable.RobotoTextView_typeface)) {
                ...
                int typefaceValue = a.getInt(R.styleable.RobotoTextView_typeface, RobotoTypefaceManager.Typeface.NOTO_SANS_CJK_KR_DEMILIGHT);
                ...
                */
                ...
                int textWeight = a.getInt(R.styleable.RobotoTextView_textWeight, RobotoTypefaceManager.TextWeight.DEMILIGHT);
                int textStyle = a.getInt(R.styleable.RobotoTextView_textStyle, RobotoTypefaceManager.TextStyle.NORMAL);
            ...
            typeface = RobotoTypefaceManager.obtainTypeface(context, RobotoTypefaceManager.Typeface.NOTO_SANS_CJK_KR_DEMILIGHT);
        }
