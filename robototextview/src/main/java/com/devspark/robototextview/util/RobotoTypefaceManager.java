...
public class RobotoTypefaceManager {
    ...
    private final static SparseArray<android.graphics.Typeface> mTypefaces = new SparseArray<android.graphics.Typeface>(7);
    ...
    */
    ...
    private static int getTypefaceValue(int fontFamily, int textWeight, int textStyle) {
        int typeface;
        if (fontFamily == FontFamily.NOTO_SANS_CJK_KR) {
            if (textWeight == TextWeight.THIN) {
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_THIN;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
                ...
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_LIGHT;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
            ...
            } else if (textWeight == TextWeight.DEMILIGHT) {
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_DEMILIGHT;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
            ...
            } else if (textWeight == TextWeight.REGUALR) {
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_REGUALR;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
                ...
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_MEDIUM;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
                ...
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_BOLD;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
            ...
            } else if (textWeight == TextWeight.BLACK) {
                switch (textStyle) {
                    case TextStyle.NORMAL:
                        typeface = Typeface.NOTO_SANS_CJK_KR_BLACK;
                        break;
                    default:
                        throw new IllegalArgumentException("`textStyle` attribute value " + textStyle +
                                " is not supported for this fontFamily " + fontFamily +
    ...
    */
    private static android.graphics.Typeface createTypeface(Context context, int typefaceValue) throws IllegalArgumentException {
        String typefacePath;
        switch (typefaceValue) {
            case Typeface.NOTO_SANS_CJK_KR_THIN:
                typefacePath = "fonts/NotoSansCJKkr-Thin.otf";
                break;
            case Typeface.NOTO_SANS_CJK_KR_LIGHT:
                typefacePath = "fonts/NotoSansCJKkr-Light.otf";
                break;
            case Typeface.NOTO_SANS_CJK_KR_DEMILIGHT:
                typefacePath = "fonts/NotoSansCJKkr-DemiLight.otf";
                break;
            case Typeface.NOTO_SANS_CJK_KR_REGUALR:
                typefacePath = "fonts/NotoSansCJKkr-Regular.otf";
                break;
            case Typeface.NOTO_SANS_CJK_KR_MEDIUM:
                typefacePath = "fonts/NotoSansCJKkr-Medium.otf";
                break;
            case Typeface.NOTO_SANS_CJK_KR_BOLD:
                typefacePath = "fonts/NotoSansCJKkr-Bold.otf";
                break;
            case Typeface.NOTO_SANS_CJK_KR_BLACK:
                typefacePath = "fonts/NotoSansCJKkr-Black.otf";
                break;
            default:
                throw new IllegalArgumentException("Unknown `typeface` attribute value " + typefaceValue);
        }
    ...
    public class Typeface {
        ...
        */
        public final static int NOTO_SANS_CJK_KR_THIN = 0;
        public final static int NOTO_SANS_CJK_KR_LIGHT = 1;
        public final static int NOTO_SANS_CJK_KR_DEMILIGHT = 2;
        public final static int NOTO_SANS_CJK_KR_REGUALR = 3;
        public final static int NOTO_SANS_CJK_KR_MEDIUM = 4;
        public final static int NOTO_SANS_CJK_KR_BOLD = 5;
        public final static int NOTO_SANS_CJK_KR_BLACK = 6;
    }
    ...
    public class FontFamily {
        ...
        */
        public static final int NOTO_SANS_CJK_KR = 0;
    }
    ...
    public class TextWeight {
        ...
        */
        ...
        public final static int DEMILIGHT = 2;
        public final static int REGUALR = 3;
